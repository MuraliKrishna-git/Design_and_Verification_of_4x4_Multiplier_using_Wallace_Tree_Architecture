...
HD_PWD='D:/Vivado/Design_and_Verification_of_4x4_Multiplier_using_Wallace_Tree_Architecture.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WallaceMultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WallaceMultiplier.tcl
